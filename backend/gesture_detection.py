...
# Ambil sub-modul secara aman langsung dari objek 'mp' utama
...
def deteksi_senyum(fitur_list: list[dict], ambang: float = 4.2) -> dict:
    # NOTE: ambang dinaikkan dari 3.4 -> 4.2. Nilai 3.4 terlalu longgar,
    # membuat wajah datar/tidak senyum tetap lolos. 4.2 masih toleran
    # terhadap variasi bentuk mulut tapi butuh senyum yang cukup jelas.
